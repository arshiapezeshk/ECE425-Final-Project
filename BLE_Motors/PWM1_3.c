 ...
 * @file PWM1_3.c
 *
 * @brief Source file for the PWM1 driver.
 *
...
{	
	...
	// Configure the PF1, PF2, and PF3 pins to use the alternate function (M1PWM6 and M1PWM7)
	// by setting Bits 2 and 3 in the AFSEL register
	GPIOF->AFSEL |= 0x02;
	GPIOF->AFSEL |= 0x04;
	GPIOF->AFSEL |= 0x08;
	...
	PWM1->_2_LOAD = (period_constant - 1);	
	...
	PWM1->_2_CMPB = (duty_cycle - 1);
	PWM1->_3_CMPA = (duty_cycle - 1);
	PWM1->_3_CMPB = (duty_cycle - 1);	
